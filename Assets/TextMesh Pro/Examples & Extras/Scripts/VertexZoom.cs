        ...
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    // Determine the random OriginalScale change for each character.
                    float randomScale = Random.Range(1f, 1.5f);

                    // Add modified OriginalScale and index
                    modifiedCharScale.Add(randomScale);
                    scaleSortingOrder.Add(modifiedCharScale.Count - 1);

                    // Setup the matrix for the OriginalScale change.
                ...
                {
                    //// Sort Quads based modified OriginalScale
