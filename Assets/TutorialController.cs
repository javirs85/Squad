...
public void StartTutorialSequence(TutorialSequence sequence)
    ...
    List<Subtitle> SignalQuality = new List<Subtitle>
    {
		...
		new Subtitle("Each one is keeping watch over not just one—but two of your brain sensors.", 3.0f),
		new Subtitle("That’s why they’ve got numbers on their tail fins—like “1–2” or “3–4”—each pair shows which electrodes they’re watching", 5.0f),
		new Subtitle("If one starts bobbing through turbulence,its signal’s getting jittery.", 4.0f),
		new Subtitle("And if it vanishes from the sky, that signal’s gone dark.", 6.0f),
